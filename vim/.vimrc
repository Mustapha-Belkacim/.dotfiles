...
" #########  Settings from https://missing.csail.mit.edu/2020/files/vimrc ########
"
...
set shiftwidth=4
set expandtab
" Different tab settings for certain file types
autocmd BufNewFile,BufRead *.yml,*.html,*.css,*.scss,*.json,*.js,*.ts
...
" Copy using xclip
vnoremap <C-C> :w !xclip -sel c <CR>

" Auto closing of brackets, braces ...
inoremap " ""<left>
inoremap ' ''<left>
inoremap ( ()<left>
inoremap [ []<left>
